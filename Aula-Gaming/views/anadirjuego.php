     ...
     <body>
        <div class="container-flex">
            <div>
                ...
                <br><br>
                <div id="inf">
                    <div class="titulo"><h1>AÑADIR JUEGO NUEVO</h1></div><br>
                        <form name="primero" method="POST" action="anadirjuego_controller.php">
                                    
                            <label name="nombre">Nombre</label>
                            <input class="form-control-md" type="text" name="nombre" pattern="[a-zA-ZáéíóúüàèìòùñÁÉÍÓÚÀÈÌÒÙÜÑ ]{2,20}"><br>
                            <p style="color:rgba(29, 27, 27, 0.432)">*Mínimo de 2, máximo de 20 letras y espacios<p>
                                            
                            <label name="descripcion">Descripcion</label>
                            <input class="form-control-md" type="text" name="descripcion" pattern="[a-zA-ZáéíóúüàèìòùñÁÉÍÓÚÀÈÌÒÙÜÑ ,.]{5,300}"><br>
                            <p style="color:rgba(29, 27, 27, 0.432)">*Minímo de 5, máximo de 300 letras, espacios, comas y puntos. <p>
