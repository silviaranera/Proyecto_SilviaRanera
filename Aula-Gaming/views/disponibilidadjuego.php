     ...
     <body>
        <div class="container-flex">
            <div>
                ...
                <br><br>
                <div id="inf">
                    <div class="titulo"><h1>CAMBIAR DISPONIBILIDAD DE LOS PUESTOS DE UN JUEGO</h1></div><br>
                        <form name="primero" method="POST" action="disponibilidadjuego_controller.php">
                            ...
                            <label>Juegos</label>
                                ...
                                ?>
                            <br><br>
                                <p style="color:rgba(29, 27, 27, 0.432)">* 0=SI disponible | 1=NO disponible</p>
                            <br>
